...
url_2 = "https://indel.becloud.by"
url_3 = f"https://indel.becloud.by/Report/ViewReport?ReportIndex=ictweb5.Domain.Reports.Heat.LocationHeatCurrentDataReportSQLDataRepositoryClass&Regions=&Locations=&Objects=&History=0&ArchiveType=1&AccountingType=0&DateFrom={stbef}Z&DateTo={stnow}Z"
url_4 = "https://indel.becloud.by/Schedule/ReadArchive?Regions=&Locations=&Objects=&Type=1&DayCount=7&HourCount=0&MinuteCount=0&EventCount=undefined&ReadUnSuccessful=undefined"
headers_1 = {
...
headers_3 = {'Accept': '*/*', 'Accept-Encoding': 'gzip, deflate, br', 'Accept-Language': 'en-GB,en;q=0.9,en-US;q=0.8',
    'Connection': 'keep-alive', 'Content-Length': '0', 'Host': 'indel.becloud.by', 'Origin': 'https://indel.becloud.by',
    'Referer': 'https://indel.becloud.by/Report/Index',
...
qut = requests.get(url="https://indel.becloud.by/Auth/Logoff", headers=headers_3)
